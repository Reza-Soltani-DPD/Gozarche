       ...
       {!data ? (
         ...
         <div className="p-2">
           ...
           <div id="title" className="flex flex-col">
             ...
             <input className="textInput" defaultValue={product?.title} onChange={(e)=>setProduct(product&&{...product,title:e.target.value})}/>
           </div>
           <div id="slug" className="flex flex-col">
             <label className="textLabel ">اسلاگ:</label>
             <input className="textInput" defaultValue={product?.slug}  onChange={(e)=>setProduct(product&&{...product,slug:e.target.value})} />
           </div>
           <div id="sku" className="flex flex-col">
             <label className="textLabel">کد محصول:</label>
             <input
               className="textInput"
               defaultValue={product?.sku ? product.sku : undefined}  onChange={(e)=>setProduct(product&&{...product,sku:e.target.value})}
             />
           </div>
           <div className="flex max-w-lg justify-around">
             ...
             <div id="ratingcount" className="flex flex-col">
               <label className="textLabel ">مجموع امتیاز‌ها :</label>
               <input
                 className="textInput"
                 type="number"
                 min="0"
                 ...
                 onChange={(e)=>setProduct(product&&{...product,ratingcount:parseFloat(e.target.value)})}
               />
             </div>
           </div>
