        ...
        <div className="grid md:grid-cols-4 lg:grid-cols-3 w-screen ">
          <div className="card mb-8 mx-2 py-2 px-4  md:col-span-2 md:col-start-2 lg:col-span-1 lg:col-start-2 ">
            <form className="flex flex-col" >
              <h1 className="w-full py-8 px-2 text-center text-lg font-bold font-vazir ">
                ثبت نام
              </h1>
            ...
            <div className='flex flex-row justify-around mb-4'>
              <div>
                <Link href="/authentication/login" className='text-sm font-vazir text-gray-400 hover:text-gray-700'>صفحه ورود</Link>
              </div>
              <div>
                <Link href={router.query?.callbackUrl?router.query.callbackUrl as string:"/"}className='text-sm font-vazir text-gray-400 hover:text-gray-700'>صفحه اصلی</Link>
              </div>
            </div>
          </div>
        </div>
